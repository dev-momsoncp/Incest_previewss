...
const products = [
  {
    title: "DARKZADIE",
    video: "https://files.catbox.moe/9k3izo.mp4",
    desc: "* 121 VIDEOS! 14GB of exclusive content Complete and well-organized folder Premium quality content Instant access for the best experience!",
    chips: ["7GB+", "HOT", "2025"],
  ...
  {
    title: "AYUMI",
    video: "https://files.catbox.moe/74sngw.mp4",
    desc: "* Over 200 amazing videos 7GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
  ...
  {
    title: "BLACK CP",
    video: "https://files.catbox.moe/ww0j9t.mp4",
    desc: "* MORE THAN 300 VIDEOS! 9.54GB of exclusive content Complete and well-organized folder Premium quality content Instant access for the best experience!",
  ...
  {
    title: "HOT CP",
    video: "https://files.catbox.moe/j8ui5l.mp4",
  ...
  {
    title: "AMELIA BLONDE",
    video: "https://files.catbox.moe/9do1pc.mp4",
    desc: "* Complete folder Premium content Instant access!",
  ...
  {
    title: "CP GAY",
    video: "https://files.catbox.moe/nb1mss.mp4",
    desc: "* MORE THAN 150 VIDEOS! 6.89GB of exclusive content Complete and well-organized folder Premium quality content Instant access for the best experience!",
  ...
  {
    title: "NEW CP",
    video: "https://files.catbox.moe/6wqxq0.mp4",
    desc: "* MORE THAN 300 VIDEOS! 10.79GB of exclusive content Complete and well-organized folder Premium quality content Instant access for the best experience!",
  ...
  {
    title: "FULL CP",
    video: "https://files.catbox.moe/uvr8oc.mp4",
...

  {
    ...
    video: "https://files.catbox.moe/hwu38l.mp4",
    desc: "* 100+ exclusive videos 4.5GB of high-quality content Complete and organized folder Premium experience guaranteed",
    chips: ["7GB+", "HOT", "2025"],
    badges: [{ label: "🔥 HOT", cls: "hot" }, { label: "NEW", cls: "new" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
...

  {
    ...
    video: "https://files.catbox.moe/3yquii.mp4",
    desc: "* 200+ VIDEOS | 12GB Complete folder Premium content Instant access!",
    chips: ["15GB+", "PREMIUM", "VIP"],
    badges: [{ label: "⭐ TOP SELLER", cls: "bestseller" }, { label: "💎 PREMIUM", cls: "premium" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "PEDMOM",
    video: "https://files.catbox.moe/pvy3ko.mp4",
    desc: "* 500+ VIDEOS | 32GB Complete folder Premium content Instant access!",
    chips: ["10GB+", "NOVO", "EXCLUSIVO"],
    badges: [{ label: "🚀 TRENDING", cls: "hot" }, { label: "✅ VERIFIED", cls: "new" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "LIZZY AND BRO",
    video: "https://files.catbox.moe/3tfw27.mp4",
    desc: "* Over 200 amazing videos 22GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["20GB+", "TOP", "2026"],
    badges: [{ label: "💥 EXCLUSIVE", cls: "hot" }, { label: "🔑 VIP", cls: "premium" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "IVANKAH AND BRO",
    video: "https://files.catbox.moe/1zmu8e.mp4",
    desc: "* Over 60 amazing videos 10GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["5GB+", "TRENDING", "FRESH"],
    badges: [{ label: "⚡ INSTANT", cls: "new" }, { label: "🏆 BEST VALUE", cls: "bestseller" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "SAVANNAH",
    video: "https://files.catbox.moe/j5sl0d.mp4",
    desc: "* Over 100 amazing videos 60.98GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["8GB+", "VERIFIED", "INSTANT"],
    badges: [{ label: "🌟 FEATURED", cls: "premium" }, { label: "🔥 HOT", cls: "hot" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "IZZY AND DOG",
    video: "https://files.catbox.moe/wnkpta.mp4",
    desc: "* Over 150 amazing videos 40GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["12GB+", "FEATURED", "BEST"],
    badges: [{ label: "💎 VIP", cls: "premium" }, { label: "🚀 NEW DROP", cls: "new" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
...

  {
    ...
    video: "https://files.catbox.moe/fp18r5.mp4",
    desc: "* 40+ VIDEOS | 2GB Complete folder Premium content Instant access!",
    chips: ["25GB+", "VIP", "POPULAR"],
    badges: [{ label: "🎯 POPULAR", cls: "bestseller" }, { label: "⚡ FAST", cls: "hot" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "BOYS",
    video: "https://files.catbox.moe/qtz6c0.mp4",
    desc: "* Over 500 amazing videos 8.25GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["7GB+", "HOT", "2025"],
    badges: [{ label: "🔥 HOT", cls: "hot" }, { label: "NEW", cls: "new" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "ENGLISH TEENS",
    video: "https://files.catbox.moe/2yb38a.mp4",
    desc: "* Over 100 amazing videos 5.5GB of exclusive content Fully organized complete folder High-quality premium content Instant Delivery After Purchase Don’t miss this opportunity!",
    chips: ["15GB+", "PREMIUM", "VIP"],
    badges: [{ label: "⭐ TOP SELLER", cls: "bestseller" }, { label: "💎 PREMIUM", cls: "premium" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "TEENS SUCKING",
    video: "https://files.catbox.moe/tvy8cl.mp4",
    desc: "* 150+ VIDEOS | 6.87GB Complete folder Premium content Instant access!",
    chips: ["10GB+", "NOVO", "EXCLUSIVO"],
    badges: [{ label: "🚀 TRENDING", cls: "hot" }, { label: "✅ VERIFIED", cls: "new" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "TEENS LEAKS",
    video: "https://files.catbox.moe/854nvm.mp4",
    desc: "* 150+ VIDEOS | 4GB Complete folder Premium content Instant access!",
    chips: ["20GB+", "TOP", "2026"],
    badges: [{ label: "💥 EXCLUSIVE", cls: "hot" }, { label: "🔑 VIP", cls: "premium" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
  ...
  {
    title: "TEENS 11-17",
    video: "https://files.catbox.moe/9iepx9.mp4",
    desc: "* 100+ VIDEOS | 7GB Complete folder Premium content Instant access!",
    chips: ["5GB+", "TRENDING", "FRESH"],
    badges: [{ label: "⚡ INSTANT", cls: "new" }, { label: "🏆 BEST VALUE", cls: "bestseller" }],
    proof: ["/proof/1.jpg", "/proof/2.jpg", "/proof/3.jpg"],
    proofCaption: "Sales proof",
